...
export type CreateLabRequestMutation = { __typename?: 'Mutation', createLabRequest: { __typename?: 'CreateLabRequestResponse', success: boolean, requiresConfirmation?: boolean | null, duplicates?: Array<{ __typename?: 'DuplicateWarning', chargeCatalogId: string, name: string, createdAt: string }> | null, previousRequests?: Array<{ __typename?: 'DuplicateWarning', chargeCatalogId: string, name: string, createdAt: string }> | null, labRequest?: { __typename?: 'LabRequest', id: string, visitId: string, testNames: Array<string>, priority: LabPriority, status: LabRequestStatus, requestedByStaffId: string, organizationId: string, createdAt: string, updatedAt: string } | null } };
...
export type FindAllLabRequestsQuery = { __typename?: 'Query', labRequests: { __typename?: 'LabRequestPaginationResult', total: number, page: number, pageCount: number, items: Array<{ __typename?: 'LabRequest', id: string, testNames: Array<string>, priority: LabPriority, status: LabRequestStatus, createdAt: string, visit: { __typename?: 'Visit', id: string, visitType: VisitType, visitDateTime: string } }> } };
...
export type StartLabRequestMutation = { __typename?: 'Mutation', startLabRequest: { __typename?: 'LabRequest', id: string, visitId: string, testNames: Array<string>, priority: LabPriority, status: LabRequestStatus, createdAt: string, updatedAt: string } };
...
export type CompleteLabRequestMutation = { __typename?: 'Mutation', completeLabRequest: { __typename?: 'LabRequest', id: string, visitId: string, testNames: Array<string>, priority: LabPriority, status: LabRequestStatus, createdAt: string, updatedAt: string } };
...
export type FindLabRequestsByVisitQuery = { __typename?: 'Query', labRequestsByVisit: Array<{ __typename?: 'LabRequest', id: string, visitId: string, testNames: Array<string>, priority: LabPriority, status: LabRequestStatus, requestedByStaffId: string, organizationId: string, createdAt: string, updatedAt: string }> };
...
export type FindLabRequestByIdQuery = { __typename?: 'Query', labRequestById: { __typename?: 'LabRequest', id: string, visitId: string, testNames: Array<string>, priority: LabPriority, status: LabRequestStatus, requestedByStaffId: string, organizationId: string, createdAt: string, updatedAt: string, visit: { __typename?: 'Visit', id: string, visitType: VisitType, visitDateTime: string } } };
