                ...
                >
                    <div className="flex items-center gap-4 p-5">
                        ...
                        <div>
                            ...
                            <p className="mt-0.5 text-xs font-semibold text-slate-400 uppercase tracking-wide">
...
function StatTile({
    ...
    return (
        <div className="rounded-2xl border border-slate-200 bg-white p-4">
            ...
            <p className="mt-0.5 text-sm font-bold text-slate-900 leading-snug">{value}</p>
        </div>
    );
}
    ...
    return (
        <div className="flex items-start gap-3">
            <div className="flex flex-col items-center pt-1">
                ...
                {isFirst && <span className="mt-1 w-px flex-1 bg-slate-200" style={{ minHeight: 28 }} />}
            </div>
            <div>
