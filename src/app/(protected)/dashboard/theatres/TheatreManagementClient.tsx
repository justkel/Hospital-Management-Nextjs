...
export default function TheatreManagementClient({
    ...
    const totalCapacity = liveItems.reduce((acc, item) => acc + (item.capacity || 0), 0);
                    ...
                    <div className="relative p-6 sm:p-8 flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="mt-3 text-slate-600 max-w-2xl text-sm sm:text-base leading-relaxed">
                                    ...
                                    streamline room utilization, and monitor critical
                                    incident reports across departments.
                                </p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full xl:w-auto">
                            <Link
                                ...
                                className="group rounded-3xl border border-rose-100 bg-white p-5 shadow-sm hover:shadow-md transition-all"
                            >
                            ...
                            <div className="rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-5">
                                ...
                                <p className="text-sm text-slate-500 mt-1 leading-relaxed">
                                    Manage utilization, floor mapping, and departmental theatre coordination.
                                </p>
                            </div>
                        </div>
                    </div>
