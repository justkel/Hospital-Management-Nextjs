...
function NavItem({
    ...
    const base =
        'flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-[13px] font-semibold transition-colors cursor-pointer';
    const cls = active
    ...
    const inner = (
        <>
            ...
            {badge !== undefined && (
                <span className="ml-auto rounded-full !bg-[#1D9E75] px-1.5 py-px text-[10px] font-bold !text-white leading-tight">
                    {badge}
                </span>
            )}
        </>
...
function NavSection({ label, children }: { label: string; children: ReactNode }) {
    return (
        <div className="mb-1">
            <p className="px-2.5 py-1.5 text-[10px] font-bold uppercase tracking-[0.1em] !text-[#B4B2A9]">
                {label}
            </p>
            {children}
        </div>
...
export default function DashboardShell({
    ...
    return (
        <div className="relative flex h-screen flex-col overflow-hidden !bg-[#F7F7F5] font-sans">
            <style>{`
            ...
            <header className="relative z-50 flex h-[52px] flex-shrink-0 items-center justify-between border-b !border-[#E8E6E0] !bg-white px-4">
                <div className="flex items-center gap-2">
                    ...
                    <span className="hidden text-[14px] font-bold tracking-[-0.01em] !text-[#2C2C2A] sm:block">
                        Dashboard
                    </span>
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Dropdown menu={{ items: userMenuItems }} placement="bottomRight" trigger={['click']}>
                        <button
                            ...
                            className="flex h-8 w-8 items-center justify-center rounded-lg !bg-[#0c1a12] text-[12px] font-semibold !text-[#5DCAA5] transition hover:opacity-80"
                        >
          ...
          `}
                >
                    <div className="flex flex-shrink-0 items-center border-b !border-[#E8E6E0] px-4 py-3.5">
                        <span className="text-[17px] font-bold italic tracking-[-0.02em] !text-[#14231A]">
                    ...
                    <div className="flex-shrink-0 border-t !border-[#E8E6E0] p-2">
                        <button
                            onClick={() => setLogoutModal(true)}
                            className="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-[13px] font-semibold !text-[#888780] transition hover:!bg-[#FEF2F2] hover:!text-[#DC2626]"
                        >
